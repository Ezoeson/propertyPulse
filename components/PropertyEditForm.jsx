...
const PropertyEditForm = () => {
   ...
   * @param {React.ChangeEvent<HTMLInputElement>} e - The event object, which contains the target input element and its value.
   * @returns {void}
   */
   ...
   * @description Handles the change event from the image input field, and adds the new files to the images array in the component state.
   * @param {React.ChangeEvent<HTMLInputElement>} e - The event object, which contains the target input element and its files.
   * @returns {void}
   */
          ...
          <div className='grid grid-cols-2 md:grid-cols-3 gap-2'>
            ...
            <div>
              <input
                ...
                onChange={handleAmenitiesChange}
              />
              <label htmlFor='amenity_smart_tv'>Coffee Maker</label>
            </div>
          </div>
        </div>
